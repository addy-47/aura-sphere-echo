    ...
    <Layout minimal>
      <div className={`flex flex-col items-center justify-center min-h-[calc(100vh-64px)] text-center px-6 py-12 relative overflow-hidden 
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center z-10 space-y-8">
          ...
          <div 
            ...
            style={{ 
              background: theme === 'dark' 
                ...
                : 'radial-gradient(circle at 30% 30%, rgba(100, 100, 100, 0.3) 0%, rgba(255, 255, 255, 0) 70%)',
          ...
          <Link 
            to="/signin" 
            className="mt-4 inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full text-white font-medium transition-all duration-300 bg-black/80 backdrop-blur-md border border-white/20 shadow-lg hover:shadow-white/10 hover:bg-black/90 w-full sm:w-auto"
            style={{
              boxShadow: theme === 'dark' ? '0 0 15px rgba(255,255,255,0.1)' : '0 0 15px rgba(0,0,0,0.1)',
              background: theme === 'dark' ? 'rgba(0,0,0,0.7)' : 'rgba(60,60,60,0.9)'
            }}
          >
