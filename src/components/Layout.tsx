...
import { Sun, Moon, Settings, MessageCircle, User, Home, Menu, X, Github } from 'lucide-react';
...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <header 
        className="sticky top-0 z-50 backdrop-blur-xl border-b border-opacity-40"
      ...
      <footer 
        className="border-t py-10 backdrop-blur-sm"
